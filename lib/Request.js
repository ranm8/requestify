...
(function(global, undefined) {
     ...
     * @param {object} params - Key-value object of params
     ...
     * @param {{ username: string, password: string, type: string }} auth - Object contains the user name and password to attach to the Authorization request header
     * @constructor
     */
    function Request(url, method, params, headers, dataType, auth) {
        if (!url) {
    ...
    Request.prototype.getUri = function() {
        ...
        if (this.method === 'GET') {
            queryObject = _.extend(queryObject, this.params);
        }
    ...
    /**
     * Returns the params encoded to JSON
     * @returns {string}
     */
    ...
    /**
     * Returns the params encoded as query string
     * @returns {string}
     */
    ...
    Request.prototype.getAuthorization = function() {
        ...
        return auth.type + ' ' + new Buffer(auth.username + ':' + auth.password).toString('base64');
    };
